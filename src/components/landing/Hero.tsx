    ...
    <section className="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-4 pt-16 pb-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
        ...
        <p className="text-lg md:text-xl text-tps-muted max-w-2xl mx-auto">
          Experience bit-perfect audio streaming directly from your device. Zero
          compression, zero tracking, purely peer-to-peer.
        </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="#features"
            className="px-6 py-3 rounded-full text-tps-muted hover:text-white transition-colors text-sm font-medium"
          >
            Learn More
          </a>
        </div>
