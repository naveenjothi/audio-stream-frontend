...
export const Logo: React.FC<{ className?: string }> = ({ className = "" }) => {
  return (
    <div className={`flex items-center gap-2 ${className}`} data-testid="tps-logo">
      <div className="relative w-8 h-8 rounded-full bg-gradient-to-br from-tps-blue to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
