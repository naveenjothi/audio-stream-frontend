  ...
  return (
    <div
      className={cn(
        ...
        variant === 'neon' && 'bg-zinc-900/80 backdrop-blur-xl border border-primary-500/30 shadow-[0_0_15px_rgba(16,185,129,0.1)]',
        // Hover effects
        hoverEffect && 'hover:border-white/20 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] hover:-translate-y-1',
        className
      )}
      {...props}
    >
